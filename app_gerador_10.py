...
# =========================================================
# LÓGICA ORIGINAL: GENESIS V.50.1 (PURE SEARCH MODE)
# (NENHUMA alteração lógica foi feita nesta seção)
# =========================================================
...
# =========================================================
# UI STREAMLIT (VISUAL V8 | LÓGICA V50.1)
# =========================================================
...
def main():
    ...
    st.set_page_config(page_title="Genesis Agency v10", page_icon="💎", layout="wide")

    # CSS Customizado para parecer uma ferramenta interna de agência (Copiado do V8)
    st.markdown(f"""
    <style>
    ...
    with col_main:
        ...
        st.write("O sistema irá selecionar a melhor oportunidade baseada no inventário e personas (V50.1 Logic).")
        generate_btn = st.button("CRIAR PAUTA ESTRATÉGICA ✨")

    if generate_btn:
        # EXECUÇÃO DA LÓGICA V50.1 (Mantida intacta)
        with st.spinner("Escaneando blog e aplicando lógica híbrida V50.1..."):
            eng = GenesisEngine()
            bld = PromptBuilder()
        ...
        # Exibição do "Raciocínio da Agência" (Visualização Rica do V8 com dados do V50.1)
        
        # Tratamento de Strings para exibição bonita
        ...
        st.markdown("### 📋 Prompt de Engenharia Reversa (V50.1)")
